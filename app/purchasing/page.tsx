    ...
    <>
      <section className="pageHero">
        <div className="container narrow">
          ...
          <h1>Connect purchasing with the rest of your business.</h1>
          <p>
            Keep supplier information and purchasing activity organised so
            incoming stock and records stay connected.
          </p>
        ...
        <div className="container">
          ...
          <div className="detailGrid">
            <Link href="/features" className="detailCard">
              ...
              <h3>Suppliers</h3>
              <p>Maintain supplier information alongside business records.</p>
              <span>
            ...
            <Link href="/features" className="detailCard">
              ...
              <p>Keep purchasing activity structured and searchable.</p>
              <span>
                Explore <ArrowRight size={14} />
              </span>
            </Link>
            <Link href="/inventory-management" className="detailCard">
              ...
              <p>Connect purchases with inventory and stock visibility.</p>
              <span>
                Explore <ArrowRight size={14} />
              </span>
            </Link>
            <Link href="/reports" className="detailCard">
              ...
              <p>Review activity through business reports.</p>
              <span>
                Explore <ArrowRight size={14} />
              </span>
            </Link>
